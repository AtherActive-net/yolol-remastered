...
export class Lexer {
    ...
    private scanToken() {
        ...
        switch(char) {
            ...
            case TokenType.COLON: this.createToken(TokenType.COLON); break;

            case TokenType.SLASH: 
                if(this.lookNext("/")) {
                    this.createToken(TokenType.DOUBLEDASH)
                } else {
            ...
            case TokenType.THEN: this.createToken(TokenType.THEN);break;

            case TokenType.END: this.createToken(TokenType.END);break;
